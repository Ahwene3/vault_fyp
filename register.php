    ...
    <div class="auth-split">
        <section class="auth-showcase">
            <div class="auth-showcase__content">
                <div class="auth-badge"><i class="bi bi-safe"></i> FYP Vault</div>
                <h1>Create your account and unlock your project vault.</h1>
                <p>Set up your student profile to submit topics, upload project files, and collaborate through each phase.</p>
            </div>
        ...
        <section class="auth-panel">
            <div class="auth-card-shell">
                ...
                <p class="auth-form-subtitle">Fill your details to join FYP Vault.</p>
                <?php if ($error): ?>
                ...
                <form method="post">
                    ...
                    <div class="auth-form-row">
                        <div class="auth-form-group">
                            <label for="index_number">Index Number <small style="color: rgba(203,213,225,0.8);">(ABC1234567 - Optional)</small></label>
                    ...
                    <div class="auth-form-group">
                        ...
                        <div id="pw-check" class="auth-check-grid">
                    ...
                    <div class="auth-form-group">
                        ...
                        <div class="auth-password-wrap">
                            ...
                            <button type="button" class="auth-password-toggle" id="togglePwConfirm" aria-label="Show or hide confirm password"><i class="bi bi-eye-fill"></i></button>
                        </div>
                        <div id="match-check" style="font-size:0.75rem; margin-top:0.35rem;"></div>
                    </div>
                    <button type="submit" class="auth-submit-btn">Create Account</button>
                </form>
                <p class="auth-switch">Already have an account? <a href="<?= base_url('index.php') ?>">Back to Sign In</a></p>
            </div>
        </section>
    </div>
    <script>
        ...
        document.getElementById('index_number').addEventListener('input', function() {
            ...
            if (!this.value) {
                ...
                check.innerHTML = '<span style="color: #34d399;"><i class="bi bi-check-circle-fill"></i> Valid format</span>';
            } else if (this.value.length < 10) {
                check.innerHTML = '<span style="color: #fbbf24;"><i class="bi bi-info-circle-fill"></i> Format: 3 letters + 7 numbers</span>';
            } else {
        ...
        document.getElementById('password').addEventListener('input', function() {
            ...
            if (pwConfirm.value) {
                ...
                if (this.value === pwConfirm.value) {
                    match.innerHTML = '<span style="color: #34d399;"><i class="bi bi-check-circle-fill"></i> Passwords match</span>';
                } else {
        ...
        document.getElementById('password_confirm').addEventListener('input', function() {
            ...
            if (!this.value) {
                ...
                match.innerHTML = '<span style="color: #34d399;"><i class="bi bi-check-circle-fill"></i> Match</span>';
            } else {
